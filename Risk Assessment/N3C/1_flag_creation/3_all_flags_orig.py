...
@transform_df(
    ...
    output=Output(
        "/dummy_directory/copd_person_all_flags"
    ),
    person=Input(
        "/dummy_directory/COPD Cohort OMOP Tables/person"
    ),
    condition_occurrence=Input(
        "/dummy_directory/COPD Cohort OMOP Tables/condition_occurrence"
    ),
    drug_exposure=Input(
        "/dummy_directory/COPD Cohort OMOP Tables/drug_exposure"
    ),
    visit_occurrence=Input(
        "/dummy_directory/COPD Cohort OMOP Tables/visit_occurrence"
    ),
    procedure_occurrence=Input(
        "/dummy_directory/COPD Cohort OMOP Tables/procedure_occurrence"
    ),
    copd_patient_deaths=Input(
        "/dummy_directory/copd_patient_deaths"
    ),
    copd_person_obesity=Input(
        "/dummy_directory/copd_person_obesity"
    ),
