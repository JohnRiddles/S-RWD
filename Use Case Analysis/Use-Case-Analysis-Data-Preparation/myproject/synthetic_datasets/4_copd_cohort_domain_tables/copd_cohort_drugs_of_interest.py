...
output_path += "/Utility-Assessment/Use-Case-Data/Synthetic-Use-Case-Data/copd_cohort_drugs_of_interest"


@transform_df(
    Output(output_path),
    drug_exposure=Input("ri.foundry.main.dataset.dummyid"),
...
def copd_cohort_drugs_of_interest(concept_set_members, drug_exposure, copd_cohort_de_id, customize_concept_sets):
    ...
    fusion_df = customize_concept_sets.filter(customize_concept_sets.domain.contains("drug")).select(
