...
output_path += "/Utility-Assessment/Use-Case-Data/Synthetic-Use-Case-Data/copd_cohort_patient_deaths"
...
def copd_cohort_patient_deaths(death, concept_set_members, copd_cohort_de_id, visit_occurrence):
    ...
    visits_df = (
        visit_occurrence.withColumnRenamed("discharged_to_concept_id", "discharge_to_concept_id")
    ...
    death_w_dates_df = (
        death_df.where((F.col("death_date") >= "2017-05-01"))
        .groupby("person_id")
