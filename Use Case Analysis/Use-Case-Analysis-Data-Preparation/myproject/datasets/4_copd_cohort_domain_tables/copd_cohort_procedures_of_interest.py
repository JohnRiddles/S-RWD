...
output_path += "/Utility-Assessment/Use-Case-Data/copd_cohort_procedures_of_interest"
...
def copd_cohort_procedures_of_interest(copd_cohort_de_id, concept_set_members, procedure_occurrence, customize_concept_sets):
