...
output_path += "/Utility-Assessment/Use-Case-Data/copd_cohort_devices_of_interest"

@transform_df(
    Output(output_path),
    device_exposure=Input("ri.foundry.main.dataset.dummyid"),
...
def copd_cohort_devices_of_interest(device_exposure, copd_cohort_de_id, concept_set_members, customize_concept_sets):
